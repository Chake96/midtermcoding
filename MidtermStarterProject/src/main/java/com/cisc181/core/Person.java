...
public abstract class Person{
	...
	public void formatPhone(String anumber){
		...
		for(String email_address : phoneNumbers)
		{
		    java.util.regex.Matcher matcher = pattern.matcher(email_address);
		    System.out.println(email_address +" : "+ matcher.matches());
		    if(matcher.matches())
		    {
